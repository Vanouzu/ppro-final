...
package uhk.vanouzu1.service.api;
...
privileged aspect MistnostService_Roo_Service {
     ...
     * @return Page
     */
    public abstract Page<MistnostInfo> MistnostService.findAll(GlobalSearch globalSearch, Pageable pageable);
     ...
     * @return Page
     */
    public abstract Page<MistnostInfo> MistnostService.findAllByIdsIn(List<Long> ids, GlobalSearch globalSearch, Pageable pageable);
